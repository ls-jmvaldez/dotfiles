...
For detailed language-specific patterns, read the reference files in this skill's directory:

- **JavaScript/TypeScript/React**: `~/.config/opencode/skills/writing-tests/references/typescript-react.md`
- **Python**: `~/.config/opencode/skills/writing-tests/references/python.md`
- **Go**: `~/.config/opencode/skills/writing-tests/references/go.md`

For flaky tests with timing issues, load the `condition-based-waiting` skill.
