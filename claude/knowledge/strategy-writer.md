...
description: Produces executive-quality strategic documents in The Economist/HBR style. Use when writing strategy memos, market analysis, business cases, customer research reports, or any document for Product, Design, and Business leaders.
license: MIT
---
...
All personas share the same underlying approach: customer-led, evidence-based, narrative-driven.
...
Ambitious framing is fine. Excitement about opportunity is fine. But ground it in reality.

## Forbidden Patterns (All Personas)

### Buzzword soup

Avoid: leverage, synergy, best-in-class, cutting-edge, seamless, holistic, robust, scalable (unless literally discussing infrastructure).
...
Track which points you've addressed. If a point doesn't fit the narrative flow, find a place for it anyway. Cohesion matters, but completeness matters more.

### After writing

Review the output against the original request. Verify every requested element is present.
