...
For detailed language-specific patterns, read the reference files:

- **JavaScript/TypeScript/React**: `~/.claude/knowledge/writing-tests/references/typescript-react.md`
- **Python**: `~/.claude/knowledge/writing-tests/references/python.md`
- **Go**: `~/.claude/knowledge/writing-tests/references/go.md`

For flaky tests with timing issues, read `~/.claude/knowledge/condition-based-waiting.md`.
