...
**For multi-component systems:** Add diagnostic logging at each component boundary before proposing fixes. See the reference file for instrumentation patterns:
`~/.claude/knowledge/systematic-debugging/references/debugging-techniques.md`

**For log-heavy investigations:** Read `~/.claude/knowledge/reading-logs.md` for efficient analysis.
...
For specific debugging methods, read the reference file:
`~/.claude/knowledge/systematic-debugging/references/debugging-techniques.md`
