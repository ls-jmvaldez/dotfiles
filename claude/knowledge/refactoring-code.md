...
```typescript
// GOOD: Behavior-driven - survives refactoring
...
// BAD: Implementation-detail - breaks during refactoring
...
**If tests are missing:** Add behavior-driven tests first using `~/.claude/knowledge/writing-tests/writing-tests.md`.
...
**If something breaks:** STOP. Read `~/.claude/knowledge/systematic-debugging/systematic-debugging.md`. Don't proceed until understood.
