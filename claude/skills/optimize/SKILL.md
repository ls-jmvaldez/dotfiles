...
argument-hint: "Optional file path or area to focus on. Defaults to unstaged changes."
---

Analyze code for performance issues and suggest optimizations. Read the knowledge file at `~/.claude/knowledge/optimizing-performance.md` before proceeding.
