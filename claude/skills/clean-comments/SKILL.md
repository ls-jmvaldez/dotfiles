...
argument-hint: "File path, directory, or glob pattern to audit. Defaults to current directory if not specified."
---
...
Read the knowledge file at `~/.claude/knowledge/documenting-code-comments.md` before proceeding and apply the guidelines:
